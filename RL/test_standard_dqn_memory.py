#!/usr/bin/env python3
"""Test standard DQN (no LSTM) memory usage"""
...
print("Testing Standard DQN Memory Usage (No LSTM)")
print("="*50)

# Standard DQN config (no R2D2/LSTM)
config = AgentConfig()
config.env_name = 'ALE/Alien-v5'
config.use_r2d2 = False  # No LSTM
