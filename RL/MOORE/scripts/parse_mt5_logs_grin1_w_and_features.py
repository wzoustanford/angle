...
def main():
    # Base directory
    base_dir = Path("/home/ubuntu//code/angle/RL/MOORE/logs/metaworld_mt5/MT5/mixture_orthogonal_experts/mt5_moore_quick_test_4e_grin1")
    #code/angle/RL/MOORE/logs/metaworld_mt5/MT5/mixture_orthogonal_experts/mt5_moore_quick_test_4e_grin1")
    #logs/metaworld_mt5/MT5/mixture_orthogonal_experts/mt5_moore_quick_test_4e_grin1")
    #logs/metaworld_mt3/MT3/mixture_orthogonal_experts/mt3_moore_quick_test_4e_pretexTrue")
