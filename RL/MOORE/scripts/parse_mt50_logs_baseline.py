...
def main():
    # Base directory
    base_dir = Path("/home/ubuntu/iclrresearch/angle/RL/MOORE/logs/metaworld/MT50/mixture_orthogonal_experts/mhsac_moore_400x3lx6e")
    ...
    tasks = [
        ...
        'shelf-place-v2', 'soccer-v2',
        'stick-push-v2', 'stick-pull-v2',
