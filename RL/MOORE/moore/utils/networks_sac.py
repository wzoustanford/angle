...
class MetaworldSACMixtureMHCriticNetworkGRINMW(nn.Module):
...
class MetaworldSACMixtureMHCriticNetworkGRINOR(nn.Module):
    def __init__(self, input_shape, 
                       output_shape, 
                       n_features,
                       activation = 'ReLU', 
        ...
        self.grin_inhibition_network = nn.Sequential(
            nn.Linear(n_experts + 2 * n_features[0] * n_experts + n_features[0] + self._n_output, 2 * n_features[0]),
            nn.Tanh(),
            nn.Linear(n_features[0] * 2, n_features[0]),
            nn.Sigmoid(),
        )
        self.n_experts = n_experts 
        self.num_grin_recurrence = num_grin_recurrence 
    ...
    def forward_once(self, state, action=None, c = None, recurrent_pass = False):
        ...
        if recurrent_pass is True: 
            ...
            features = features * inhibition_logits
...
class MetaworldSACMixtureMHCriticNetworkGRINIR(nn.Module):
    def __init__(self, input_shape, 
                       output_shape, 
                       n_features,
                       activation = 'ReLU', 
        ...
        self.grin_inhibition_network = nn.Sequential(
            nn.Linear(n_experts + 2 * n_features[0] * n_experts + n_features[0] + self._n_output, 2 * n_features[0]),
            nn.Tanh(),
            nn.Linear(n_features[0] * 2, self._n_input[0]),
            nn.Sigmoid(),
        )
        self.n_experts = n_experts 
        self.num_grin_recurrence = num_grin_recurrence 
    ...
    def forward_once(self, state, action=None, c = None, recurrent_pass = False):
        ...
        if recurrent_pass is True: 
            ...
            state_action = state_action * inhibition_logits
...
class MetaworldSACMixtureMHActorNetworkGRINMW(nn.Module):
    def __init__(self, input_shape, 
                       output_shape, 
                       n_features,
                       activation = 'ReLU', 
...
class MetaworldSACMixtureMHActorNetworkGRINOR(nn.Module):
    def __init__(self, input_shape, 
                       output_shape, 
                       n_features,
                       activation = 'ReLU', 
...
class MetaworldSACMixtureMHActorNetworkGRINIR(nn.Module):
    def __init__(self, input_shape, 
                       output_shape, 
                       n_features,
                       activation = 'ReLU', 
    ...
    def forward_once(self, state, c = None, recurrent_pass = False):
        ...
        if recurrent_pass is True: 
            ...
            #features_inhibition_logits = inhibition_logits[:, self.n_experts:]
            #inhibition_logits = inhibition_logits.unsqueeze(1)
            state = state * inhibition_logits

        # shared features
        features = self._h(state)
