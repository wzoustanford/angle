...
cd ../../
python run_metaworld_sac_mt.py  --seed ${SEED} --n_exp 1 --exp_type MT10 --exp_name mhsac_moore_datacol_400x3lx${N_EXPERTS}e --results_dir logs/metaworld \
                                ...
                                --n_episodes_test 10 --train_frequency 1 --sample_task_per_episode --rl_checkpoint_interval 3 --load_agent /home/ubuntu/iclrwzou/angle/RL/MOORE/logs/metaworld/MT10/mixture_orthogonal_experts/mhsac_moore_400x3lx4e/seed_12/agent/agent_final