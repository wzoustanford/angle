...
cd ../../
python run_metaworld_sac_mt.py  --seed ${SEED} --n_exp 1 --exp_type MT50 --exp_name mhsac_moore_sa_datacol_400x3lx${N_EXPERTS}e --results_dir logs/metaworld \
                                ...
                                --n_episodes_test 10 --train_frequency 1 --sample_task_per_episode --rl_checkpoint_interval 1 --use_cuda --load_agent /home/ubuntu/iclrwzou/angle/RL/MOORE/sa_logs/mhsac_moore_400x3lx6e/seed_2/agent/agent_16
