...
# Quick MT5 test script for MetaWorld with MOORE
# Usage: sh run_metaworld_mt5_quick_test.sh [N_EXPERTS] [SEED]
# Example: sh run_metaworld_mt5_quick_test.sh 3 0
...
python run_metaworld_sac_mt.py \
    ...
    --n_exp 1 \
    --exp_type MT5 \
    --exp_name mt5_moore_quick_test_w_inh_reverted_${N_EXPERTS}e_pretex${USE_PRETEX} \
