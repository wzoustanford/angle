...
cd ../../
python run_metaworld_sac_mt.py  --seed ${SEED} --n_exp 1 --exp_type MT3 --exp_name mhsac_moore_400x3lx${N_EXPERTS}e --results_dir logs/metaworld \
                                --batch_size 128 --n_epochs 2 --n_steps 100000 --horizon 150 --gamma 0.99 --lr_actor 3e-4 --lr_critic 3e-4 --lr_alpha 1e-4 --log_std_min -10 --log_std_max 2 \
