...
cd ../../
python run_metaworld_sac_mt.py  --seed ${SEED} --n_exp 1 --exp_type MT5 --exp_name mhsac_moore_GRIN_400x3lx${N_EXPERTS}e_rec${NUM_GRIN_RECURRENCE} --results_dir logs/metaworld \
