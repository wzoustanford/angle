...
class MT3(Benchmark):
    """Custom MT3 benchmark with only 3 tasks for faster experiments."""
    def __init__(self, seed=None):
        super().__init__()
        # Select first 3 tasks from MT10 for quick experiments
        # These are: reach-v2, push-v2, and pick-place-v2
        mt10_classes = _env_dict.MT10_V2
        task_names = list(mt10_classes.keys())[:3]
