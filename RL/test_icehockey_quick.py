#!/usr/bin/env python3
"""
Quick test script for Ice Hockey game
"""
...
def test_icehockey():
    """Quick test with Ice Hockey game"""
    print("Testing Ice Hockey game with Basic DQN (1 episode)")
    
    # Create basic config
    config = AgentConfig()
    config.env_name = 'ALE/IceHockey-v5'
    ...
    try:
        ...
        print("\n✓ Test successful! Ice Hockey environment is working.")
